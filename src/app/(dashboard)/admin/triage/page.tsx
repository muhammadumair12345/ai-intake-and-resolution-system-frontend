...
import { useGetTriageQueueQuery } from "@/lib/redux/api/ticketApi";
...
import { AlertTriangle, Stars, Search, FilterX } from "lucide-react";
...
export default function AdminTriagePage() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetTriageQueueQuery(queryParams);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Tickets with low AI confidence or requiring manual assignment."
        icon={Stars}
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {meta?.total || 0} tickets needing review.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DataTable
