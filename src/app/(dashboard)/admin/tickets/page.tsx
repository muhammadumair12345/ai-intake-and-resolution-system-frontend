...
import { Ticket as TicketIcon, Search, FilterX } from "lucide-react";
...
export default function AdminTicketsPage() {
  ...
  const queryParams: PaginationParams = {
    ...
    limit,
    sort,
    order: order as "asc" | "desc", // Cast as needed by your API type
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Monitor and manage every support request across the system."
        icon={TicketIcon}
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {meta?.total || 0} support requests.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DataTable
